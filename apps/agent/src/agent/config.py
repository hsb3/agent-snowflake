...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        - AGENT_SNOWFLAKE_DATABASE: Snowflake database
        - AGENT_SNOWFLAKE_SCHEMA: Snowflake schema
        - AGENT_SNOWFLAKE_WAREHOUSE: Snowflake warehouse
        - AGENT_SNOWFLAKE_ROLE: Snowflake role
        ...
        - AGENT_CORS_ORIGINS: Comma-separated CORS origins
        - AGENT_ENVIRONMENT: Environment (development/staging/production)
        ...
        return cls(
            ...
            snowflake_role=os.environ.get("AGENT_SNOWFLAKE_ROLE", ""),
            allowed_schemas=os.environ.get("AGENT_ALLOWED_SCHEMAS", "*"),
            allowed_tables=os.environ.get("AGENT_ALLOWED_TABLES", "*"),
            read_only=os.environ.get("AGENT_READ_ONLY", "true").lower() == "true",
            query_timeout=int(os.environ.get("AGENT_QUERY_TIMEOUT", "30")),
            max_iterations=int(os.environ.get("AGENT_MAX_ITERATIONS", "25")),
            enable_debug=os.environ.get("AGENT_ENABLE_DEBUG", "false").lower() == "true",
